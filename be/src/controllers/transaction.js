...
class TransactionController {
    ...
    static async edit(req, res) {
        try {
            ...
            // Validate required fields
            if (!date || !amount || !type || !categoryId) {return res.status(400).json({ message: 'Missing required fields' });
        }
...
static async delete(req, res) {
    try {
        ...
        await TransactionController.updateBudget(userId, transaction.categoryId, transaction.date);
