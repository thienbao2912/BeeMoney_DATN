                    ...
                    <div className="card-body">
                        {isLoading ? (
                            ...
                            <>
                                {error && <p>{error}</p>}
                                <div className="mb-3">
                                    <label htmlFor="filter" className="form-label">Lọc theo loại</label>
                                    <select
                                        id="filter"
                                                ...
                                                <tbody>
                                                    {displayedCategories.map((category, index) => (
                                                        <tr key={category._id || `category-${index}`}>
                                                            <td className='align-middle'>{(currentPage - 1) * categoriesPerPage + index + 1}</td>
                                                            ...
                                                            <td className='align-middle'>{category.type}</td>
