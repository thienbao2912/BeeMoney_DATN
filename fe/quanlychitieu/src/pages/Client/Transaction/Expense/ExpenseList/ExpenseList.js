      ...
      case "category":
        if (selectedCategory) {
          filtered = filtered.filter(
            (expense) => expense.categoryId?._id === selectedCategory
          );
        }
        break;
      case "month":
      ...
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item">
            <Link className="text-secondary" to="/expense/add">
              Thêm chi tiêu
            </Link>
          </li>
        </ol>
              ...
              <thead>
                <tr>
                  <th
                    scope="col"
                    style={{ width: "20%" }}
                    className="text-secondary text-xxs"
                  >
                    Danh mục
                  </th>
                  <th
                    scope="col"
                    style={{ width: "20%" }}
                    className="text-secondary text-xxs font-weight-bolder opacity-7"
                  >
                    Ghi chú
                  </th>
                  <th
