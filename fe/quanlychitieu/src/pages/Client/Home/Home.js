                            ...
                            <div className="d-flex justify-content-center mb-3">
                                <div className="btn-group btn-group-sm">
                                    <button
                                        ...
                                        style={{
                                            backgroundColor: showExpenses ? '#711ae1' : '', // Khi button "Chi tiêu" được chọn, nền sẽ là #711ae1
                                            color: showExpenses ? '#fff' : '', // Thay đổi màu chữ khi chọn
                                        }}
                                    >
                                        Chi tiêu
                                    </button>
                                    <button
                                        ...
                                        style={{
                                            backgroundColor: !showExpenses ? '#711ae1' : '', // Khi button "Thu nhập" được chọn, nền sẽ là #711ae1
                                            color: !showExpenses ? '#fff' : '', // Thay đổi màu chữ khi chọn
                                        }}
                                    >
                                        Thu nhập
                                ...
                                <>
                                    {expenseDetails.slice(0, 5).length > 0 ? (
                                        expenseDetails.slice(0, 5).map((expense, index) => (
                                            <div
                                                key={index}
                                                className="history-details d-flex px-2 py-1 align-items-center justify-content-between mb-2"
                                                style={{
                                                    border: "1px solid #e0e0e0", // Viền ban đầu
                                                    borderRadius: "8px",
                                                ...
                                                onMouseEnter={(e) => {
                                                    ...
                                                    // e.currentTarget.style.borderColor = "#007bff"; // Đổi màu viền khi hover
                                                }}
                                                onMouseLeave={(e) => {
                                                    e.currentTarget.style.transform = "translateY(0)";
                                                    e.currentTarget.style.boxShadow = "none";
                                                    e.currentTarget.style.borderColor = "#e0e0e0"; // Trả về màu viền ban đầu
                                                }}
                                            >
          ...
          <div className="card-body">
            ...
            {currentIncomes.length > 0 ? (
              currentIncomes.map((category, index) => (
                <div key={index}><div className="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2">
                <div className="d-flex align-items-center">
                  <img
                    src={category.categoryImage || "../images/no.png"}
                    className="rounded-circle me-3"
